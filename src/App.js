...
const App = () => {
	...
	return (
		<main>
			...
			{
				  gameStarted && gameOptions.category && gameOptions.difficulty && gameOptions.type ? 
						...
						<div className="gameOptions-container">
							<div className="select-container">
								...
								<select
									name="category"
									id="category"
									className= {gameStarted && !gameOptions.category ? "custom-select empty-select" : "custom-select" }
							...
							<div className="select-container">
								...
								<select
									name="difficulty"
									id="difficulty"
									className={gameStarted && !gameOptions.difficulty? "custom-select empty-select" : "custom-select" }
							...
							<div className="select-container">
								...
								<select
									name="type"
									id="type"
									className={gameStarted && !gameOptions.type? "custom-select empty-select" : "custom-select" }
